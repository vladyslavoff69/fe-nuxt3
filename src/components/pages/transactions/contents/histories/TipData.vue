...
import { MY_TIPS_QUERY } from '~/graphql'
import type { Tip } from '~/types'
import { AUTH, THEME, TIP_DEPOSIT, TIP_WITHDRAW } from '~/constants'
...
const requestParams = computed(() => ({
  ...
  types: [TIP_WITHDRAW, TIP_DEPOSIT],
...
<template>
  <div class="w-full h-auto p-0 m-0">
    <div class="flex items-center justify-between mb-4 gap-3 w-full flex-wrap md:flex-nowrap">
      ...
      <div class="flex items-center gap-x-1 lg:justify-end">
        <JButton
          variant="outline"
